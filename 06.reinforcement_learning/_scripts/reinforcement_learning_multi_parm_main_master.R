...
run_rl_mp <- function(modelType = 'indv') {
    ...
    ## no show ##
    # tmp <- readMat('_data/rl_mp.mat')
    # rl_mp <- tmp$data
    # save(rl_mp, file = "_data/rl_mp.RData")
    # 
    # tmp <- readMat('_data/rl_mp_parms_optm.mat')
    # rl_mp_parms <- tmp$rl.par
    # save(rl_mp_parms, file = "_data/rl_mp_parms_optm.RData")
    ...
    if (modelType=='indv') {
        ...
        ggsave(plot = plot_dens_lr, "_plots/lr_mp_indv_lr_dens.png", width = 3, height = 4, type = "cairo-png", units = "in")
        ggsave(plot = plot_dens_tau, "_plots/lr_mp_indv_tau_dens.png", width = 3, height = 4, type = "cairo-png", units = "in")
    ...
    if (modelType=='indv') {
        ggsave(plot = g1, "_plots/lr_mp_inv_violin.png", width = 4, height = 4, type = "cairo-png", units = "in")
    } else {
